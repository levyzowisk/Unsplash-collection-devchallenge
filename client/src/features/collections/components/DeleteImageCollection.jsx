...
export default function DeleteImageCollection({ onClose, onDelete }) {
    return (
        <>
        ...
        <div className="flex justify-end items-start  gap-2 mt-2">
                ...
                <Button text={"Excluir"} className={"p-2 bg-black hover:bg-black/77 text-white rounded-lg px-6 cursor-pointer"}  onClick={() => {
                    onDelete();
                    onClose(); 
                }}/>
        </div>
